...
When it's your turn, click **Done**. The turn advances to the next person automatically.

Did the activity when it wasn't your turn? Use **Done by me** from the three-dot menu. You get credit, but the rotation continues normally.

View complete history anytime from the three-dot menu.
